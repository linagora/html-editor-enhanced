				...
				return e = t, (n = [{
					...
					value: function() {
						...
						this.documentEventHandlers.onDragenter = function(o) {
                            ...
                            } else if (n && n.types && n.types.length) {
                              let indexTypeHtml = n.types.indexOf("text/html");
                              if (indexTypeHtml > -1) {
                                const newTypes = n.types.filter(type => {
                                  return type !== "text/plain";
                                });

                                i.a.each(newTypes, (function(e, o) {
                                  if (!(o.toLowerCase().indexOf("_moz_") > -1)) {
                                    var r = n.getData(o);
                                    if (o.toLowerCase().indexOf("text") > -1) {
                                ...
                                i.a.each(n.types, (function(e, o) {
                                  if (!(o.toLowerCase().indexOf("_moz_") > -1)) {
                                    var r = n.getData(o);
                                    if (o.toLowerCase().indexOf("text") > -1) {
                                      let modifiedText = r.replace(/(?:\r\n|\r|\n)/g, '<br>');
                                      t.context.invoke("editor.pasteHTML", modifiedText);
                                    } else {
                                      i()(r).each((function(e, n) {
                                        t.context.invoke("editor.insertNode", n)
                                      }));
