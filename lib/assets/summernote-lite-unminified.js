/*! For license information please see summernote-lite.min-v2.js.LICENSE.txt */ ! function(t, e) {
  ...
  return function(t) {
    ...
    1: function(t, e, n) {
      ...
      var s = function() {
        ...
        function o(t, e, n, i) {
          ...
          }(this, o), this.markup = t, this.children = e, this.options = n, this.callback = i
        }
        return t = o, e = [{
          key: "render",
          value: function(t) {
        ...
        }, ], r(t.prototype, e), n && r(t, n), o
      }();
      e.a = {
        create: function(t, e) {
          return function() {
            var n = "object" === a(arguments[1]) ? arguments[1] : arguments[0],
    ...
    3: function(t, e, n) {
      ...
      i.a.summernote = i.a.summernote || {
        ...
        "en-US": {
          ...
          image: {
            ...
            dragImageHere: "Drop file here to attach them",
            dropImage: "Drop file here to attach them",
      ...
      var a = "function" == typeof define && n(2),
        r = ["sans-serif", "serif", "monospace", "cursive", "fantasy"];

      function s(t) {
        return -1 === i.a.inArray(t.toLowerCase(), r) ? "'".concat(t, "'") : t
      }
      ...
      var h = /Edge\/\d+/.test(c),
        ...
        p = {
          ...
          inputEventName: u ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input",
      ...
      var C = {
        ...
        clusterBy: function(t, e) {
          ...
          return t.length ? k(t).reduce(function(t, n) {
            var o = b(t);
            return e(b(o), n) ? o[o.length] = n : t[t.length] = [n], t
          }, [
            [(n = t)[0]]
          ]) : []
        },
      ...
      function P(t) {
        return !(D(t) || R(t) || L(t) || _(t) || I(t) || F(t) || E(t))
      }
      ...
      var H = x("A"),
        B = x("BODY"),
        z = p.isMSIE && p.browserVersion < 11 ? "&nbsp;" : "<br>";
      ...
      function O(t) {
        var e = M(t);
        return 0 === e || !$(t) && 1 === e && t.innerHTML === z || !(!C.all(t.childNodes, $) || "" !== t.innerHTML)
      }

      function U(t) {
        S(t) || M(t) || (t.innerHTML = z)
      }
      ...
      function Q(t, e) {
        if (!e) return !1;
        for (; t && t !== e;) {
          if (J(t) !== M(t.parentNode) - 1) return !1;
          t = t.parentNode
        }
        return !0
      }
      ...
      function te(t, e) {
        ...
        } else tt(t.node) ? o = M(n = t.node.childNodes[t.offset - 1]) : (n = t.node, o = e ? 0 : t.offset - 1);
        return {
          node: n,
          offset: o
        }
      ...
      function tn(t, e) {
        var n, o;
        if (M(t.node) === t.offset) {
          if (w(t.node)) return null;
          var i = ti(t.node);
          i ? (n = i, o = 0) : (n = t.node.parentNode, o = J(t.node) + 1)
        } else tt(t.node) ? (n = t.node.childNodes[t.offset], o = 0) : (n = t.node, o = e ? M(t.node) : t.offset + 1);
        return {
          node: n,
          offset: o
        }
      ...
      function to(t, e) {
        ...
        if (M(t.node) === t.offset) {
          if (w(t.node)) return null;
          var i = ti(t.node);
          i ? (n = i, o = 0) : (n = t.node.parentNode, o = J(t.node) + 1), w(n) && (n = t.node.nextSibling, o = 0)
        } else if (tt(t.node)) {
          if (o = 0, O(n = t.node.childNodes[t.offset])) return null
        } else if (n = t.node, o = e ? M(t.node) : t.offset + 1, O(n)) return null;
        return {
          node: n,
          offset: o
        }
      ...
      function ti(t) {
        if (t.nextSibling && t.parent === t.nextSibling.parent) return $(t.nextSibling) ? t.nextSibling : ti(t.nextSibling)
      }
      ...
      function tr(t, e) {
        ...
        if (i && (n = !0), Z(t) && ($(t.node) || o)) {
          if (G(t)) return t.node;
          if (Y(t)) return t.node.nextSibling
        }
        if ($(t.node)) return t.node.splitText(t.offset);
        var a = t.node.childNodes[t.offset],
          r = V(t.node.cloneNode(!1), t.node);
        return q(r, K(a)), n || (U(t.node), U(r)), i && (O(t.node) && tc(t.node), O(r)) ? (tc(r), t.node.nextSibling) : r
      }

      function ts(t, e, n) {
        var o = j(e.node, m.eq(t));
        return o.length ? 1 === o.length ? tr(e, n) : o.reduce(function(t, o) {
          return t === e.node && (t = tr(e, n)), tr({
            node: o,
            offset: t ? J(t) : M(o)
          }, n)
        }) : null
      ...
      function tc(t, e) {
        if (t && t.parentNode) {
          ...
          var n = t.parentNode;
          if (!e) {
            for (var o = [], i = 0, a = t.childNodes.length; i < a; i++) o.push(t.childNodes[i]);
            for (var r = 0, s = o.length; r < s; r++) n.insertBefore(o[r], t)
          }
          n.removeChild(t)
        }
      }
      ...
      var tP = function() {
        ...
        return t = o, e = [{
          ...
          key: "addRow",
          value: function(t, e) {
            for (var n = th.ancestor(t.commonAncestor(), th.isCell), o = i()(n).closest("tr"), a = this.recoverAttributes(o), r = i()("<tr" + a + "></tr>"), s = new tE(n, tE.where.Row, tE.requestAction.Add, i()(o).closest("table")[0]).getActionList(), l = 0; l < s.length; l++) {
              var c = s[l],
                u = this.recoverAttributes(c.baseCell);
              switch (c.action) {
                case tE.resultAction.AddCell:
                  r.append("<td" + u + ">" + th.blank + "</td>");
                  break;
                case tE.resultAction.SumSpanCount:
                  if ("top" === e && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= o[0].rowIndex) {
                    var d = i()("<div></div>").append(i()("<td" + u + ">" + th.blank + "</td>").removeAttr("rowspan")).html();
                    r.append(d);
                    break
                  }
          ...
          value: function(t, e) {
            ...
            for (var a = new tE(n, tE.where.Column, tE.requestAction.Add, i()(o).closest("table")[0]).getActionList(), r = 0; r < a.length; r++) {
              ...
              switch (s.action) {
                case tE.resultAction.AddCell:
                  "right" === e ? i()(s.baseCell).after("<td" + l + ">" + th.blank + "</td>") : i()(s.baseCell).before("<td" + l + ">" + th.blank + "</td>");
                  break;
                case tE.resultAction.SumSpanCount:
                  if ("right" === e) {
                    var c = parseInt(s.baseCell.colSpan, 10);
                    c++, s.baseCell.setAttribute("colSpan", c)
                  } else i()(s.baseCell).before("<td" + l + ">" + th.blank + "</td>")
              }
            }
          }
        }, {
          ...
          key: "createTable",
          value: function(t, e, n) {
            for (var o, a = [], r = 0; r < t; r++) a.push("<td>" + th.blank + "</td>");
            o = a.join("");
          ...
          key: "deleteTable",
          value: function(t) {
            var e = th.ancestor(t.commonAncestor(), th.isCell);
            i()(e).closest("table").remove()
          }
        }, ], tI(t.prototype, e), n && tI(t, n), o
      }();
      ...
      var tL = function() {
        ...
        function o(t) {
          ...
          this.insertParagraph = this.wrapCommand(function() {
            e.typing.insertParagraph(e.editable)
          }), this.insertOrderedList = this.wrapCommand(function() {
            e.bullet.insertOrderedList(e.editable)
          }), this.insertUnorderedList = this.wrapCommand(function() {
            e.bullet.insertUnorderedList(e.editable)
          }), this.indent = this.wrapCommand(function() {
            e.bullet.indent(e.editable)
          }), this.outdent = this.wrapCommand(function() {
            e.bullet.outdent(e.editable)
          }), this.insertNode = this.wrapCommand(function(t) {
            e.isLimited(i()(t).text().length) || (e.getLastRange().insertNode(t), e.setLastRange(tk.createFromNodeAfter(t).select()))
          }), this.insertText = this.wrapCommand(function(t) {
            if (!e.isLimited(t.length)) {
              var n = e.getLastRange().insertNode(th.createText(t));
              e.setLastRange(tk.create(n, th.nodeLength(n)).select())
            }
          }), this.pasteHTML = this.wrapCommand(function(t) {
            if (!e.isLimited(t.length)) {
              t = e.context.invoke("codeview.purify", t);
              var n = e.getLastRange().pasteHTML(t);
              e.setLastRange(tk.createFromNodeAfter(C.last(n)).select())
            }
          }), this.formatBlock = this.wrapCommand(function(t, n) {
            var o = e.options.callbacks.onApplyCustomStyle;
            o ? o.call(e, n, e.context, e.onFormatBlock) : e.onFormatBlock(t, n)
          }), this.insertHorizontalRule = this.wrapCommand(function() {
            var t = e.getLastRange().insertNode(th.create("HR"));
            t.nextSibling && e.setLastRange(tk.create(t.nextSibling, 0).normalize().select())
          }), this.lineHeight = this.wrapCommand(function(t) {
            e.style.stylePara(e.getLastRange(), {
              lineHeight: t
            })
            ...
            var n = t.url,
              ...
              a = t.isNewWindow,
              r = t.checkProtocol,
              s = t.range || e.getLastRange(),
              l = o.length - s.toString().length;
            if (!(l > 0 && e.isLimited(l))) {
              var c = s.toString() !== o;
              "string" == typeof n && (n = n.trim()), e.options.onCreateLink ? n = e.options.onCreateLink(n) : r && (n = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(n) ? n : e.options.defaultProtocol + n);
              var u = [];
              if (c) {
                var d = (s = s.deleteContents()).insertNode(i()("<A>" + o + "</A>")[0]);
                u.push(d)
              } else u = e.style.styleNodes(s, {
                nodeName: "A",
                expandClosestSibling: !0,
                onlyPartialContains: !0
              });
              i.a.each(u, function(t, e) {
                i()(e).attr("href", n), a ? i()(e).attr("target", "_blank") : i()(e).removeAttr("target")
              }), e.setLastRange(e.createRangeFromList(u).select())
            }
            ...
            var n = t.split("x");
            e.getLastRange().deleteContents().insertNode(e.table.createTable(n[0], n[1], e.options))
          }), this.removeMedia = this.wrapCommand(function() {
            var t = i()(e.restoreTarget()).parent();
            t.closest("figure").length ? t.closest("figure").remove() : t = i()(e.restoreTarget()).detach(), e.context.triggerEvent("media.delete", t, e.$editable)
          }), this.floatMe = this.wrapCommand(function(t) {
            var n = i()(e.restoreTarget());
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            this.$editable.on("keydown", function(e) {
              if (e.keyCode === tC.code.ENTER && t.context.triggerEvent("enter", e), t.context.triggerEvent("keydown", e), t.snapshot = t.history.makeSnapshot(), t.hasKeyShortCut = !1, e.isDefaultPrevented() || (t.options.shortcuts ? t.hasKeyShortCut = t.handleKeyMap(e) : t.preventDefaultEditableShortCuts(e)), t.isLimited(1, e)) {
            ...
            }), this.$editable.attr("spellcheck", this.options.spellCheck), this.$editable.attr("autocorrect", this.options.spellCheck), this.options.disableGrammar && this.$editable.attr("data-gramm", !1), this.$editable.html(th.html(this.$note) || th.emptyPara), this.$editable.on(p.inputEventName, m.debounce(function() {
          ...
          key: "isLimited",
          value: function(t, e) {
            return t = t || 0, (void 0 === e || !(tC.isMove(e.keyCode) || tC.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || C.contains([tC.code.BACKSPACE, tC.code.DELETE], e.keyCode))) && this.options.maxTextLength > 0 && this.$editable.text().length + t > this.options.maxTextLength
          }
        }, {
          key: "createRange",
          value: function() {
          ...
          value: function(t) {
            var e = tk.createFromNodeBefore(C.head(t)).getStartPoint(),
              n = tk.createFromNodeAfter(C.last(t)).getEndPoint();
            return tk.create(e.node, e.offset, n.node, n.offset)
          }
        }, {
          key: "setLastRange",
          value: function(t) {
            t ? this.lastRange = t : (this.lastRange = tk.create(this.editable), 0 === i()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = tk.createFromBodyElement(this.editable)))
          }
        }, {
          key: "getLastRange",
          value: function() {
          ...
          value: function(t, e) {
            ...
            return (n = t, i.a.Deferred(function(t) {
              ...
              o.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(o.$editable.width(), t.width()))), t.show(), o.getLastRange().insertNode(t[0]), o.setLastRange(tk.createFromNodeAfter(t[0]).select()), o.afterCommand()
            }).fail(function(t) {
          ...
          value: function(t) {
            ...
            i.a.each(t, function(t, n) {
              var o, a = n.name;
              e.options.maximumImageFileSize && e.options.maximumImageFileSize < n.size ? e.context.triggerEvent("image.upload.error", file, e.lang.image.maximumFileSizeError) : (o = n, i.a.Deferred(function(t) {
          ...
          value: function() {
            var t = this.getLastRange();
            return t.isOnAnchor() && (t = tk.createFromNode(th.ancestor(t.sc, th.isAnchor))), t.toString()
          }
        }, {
          key: "onFormatBlock",
          value: function(t, e) {
          ...
          value: function(t, e) {
            ...
            if ("" !== n) {
              ...
              if (this.$editor.find(".note-status-output").html(""), i()(o).css(t, e), n.isCollapsed()) {
                var a = C.head(o);
                a && !th.nodeLength(a) && (a.innerHTML = th.ZERO_WIDTH_NBSP_CHAR, tk.createFromNode(a.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", a))
              } else this.setLastRange(this.createRangeFromList(o).select())
            } else {
              var r = i.a.now();
              this.$editor.find(".note-status-output").html('<div id="note-status-output-' + r + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>"), setTimeout(function() {
                i()("#note-status-output-" + r).remove()
              }, 5e3)
            }
          }
        }, {
          ...
          value: function() {
            var t = this.getLastRange();
            if (t.isOnAnchor()) {
              var e = th.ancestor(t.sc, th.isAnchor);
              (t = tk.createFromNode(e)).select(), this.setLastRange(), this.beforeCommand(), document.execCommand("unlink"), this.afterCommand()
            }
          }
        }, {
          key: "getLinkInfo",
          value: function() {
            var t = this.getLastRange().expand(th.isAnchor),
          ...
          key: "isEmpty",
          value: function() {
            return th.isEmpty(this.$editable[0]) || th.emptyPara === this.$editable.html()
          }
        }, {
          key: "empty",
          value: function() {
            this.context.invoke("code", th.emptyPara)
          }
        }, {
      ...
      var tF = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.$editable = t.layoutInfo.editable
        }
        return t = o, e = [{
          key: "initialize",
          value: function() {
          ...
          value: function(t) {
            ...
            if (n && n.items && n.items.length) {
              if (n.items.length > 1) {
                const filteredItems = Array.from(n.items)
                  .filter(item => item.kind === "file" && item.type.indexOf("image/") !== -1);
                if (filteredItems && filteredItems.length > 0) {
                  const files = filteredItems
                    .map(item => item.getAsFile())
                    .filter(file => file !== null);
                  this.context.invoke("editor.insertImagesOrCallback", files);
                  t.preventDefault();
                } else {
                  var o = n.items[1];
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            this.documentEventHandlers.onDragenter = function(o) {
              let i = o.originalEvent.dataTransfer,
                a = i.types.filter(t => "Files" === t);
              if (a && a.length) {
                var r = t.context.invoke("codeview.isActivated"),
                  s = t.$editor.width() > 0 && t.$editor.height() > 0;
                r || e.length || !s || (t.$editor.addClass("dragover"), t.$dropzone.width() || t.$dropzone.width(t.$editor.width()), t.$dropzone.height() || t.$dropzone.height(t.$editor.height()), n.text(t.lang.image.dragImageHere)), e = e.add(o.target)
              }
              ...
              e.preventDefault(), n && n.files && n.files.length ? (t.$editable.focus(), t.context.invoke("editor.insertImagesOrCallback", n.files)) : i.a.each(n.types, function(e, o) {
                if (!(o.toLowerCase().indexOf("_moz_") > -1)) {
                  var a = n.getData(o);
                  o.toLowerCase().indexOf("text") > -1 ? t.context.invoke("editor.pasteHTML", a) : i()(a).each(function(e, n) {
      ...
      var tz = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.$editor = t.layoutInfo.editor, this.$editable = t.layoutInfo.editable, this.$codable = t.layoutInfo.codable, this.options = t.options, this.CodeMirrorConstructor = window.CodeMirror, this.options.codemirror.CodeMirrorConstructor && (this.CodeMirrorConstructor = this.options.codemirror.CodeMirrorConstructor)
        }
        return t = o, e = [{
          key: "sync",
          value: function(t) {
          ...
          value: function() {
            ...
            this.$codable.on("keyup", function(e) {
              e.keyCode === tC.code.ESCAPE && t.deactivate()
            })
          }
        }, {
          key: "isActivated",
              ...
              t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function(t) {
                ...
                var n, o = function t(e) {
                  if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
                    if (Array.isArray(e) || (e = function(t, e) {
                        if (t) {
                          if ("string" == typeof t) return t1(t, e);
                          var n = Object.prototype.toString.call(t).slice(8, -1);
                          if ("Object" === n && t.constructor && (n = t.constructor.name), "Map" === n || "Set" === n) return Array.from(n);
                          if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return t1(t, e)
                        }
                      }(e))) {
                      var n = 0,
                        o = function() {};
                ...
                try {
                  for (o.s(); !(n = o.n()).done;) {
                    var i = n.value;
                    if (RegExp('src="(https?:)?//' + i.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + '/(.+)"').test(t)) return t
                  }
                } catch (a) {
                  o.e(a)
                } finally {
          ...
          value: function() {
            ...
            if (this.$codable.val(th.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.context.invoke("airPopover.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), e) {
          ...
          value: function() {
            ...
            var e = this.purify(th.value(this.$codable, this.options.prettifyHtml) || th.emptyPara),
      ...
      var tM = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.$document = i()(document), this.$statusbar = t.layoutInfo.statusbar, this.$editable = t.layoutInfo.editable, this.options = t.options
        }
        return t = o, e = [{
          key: "initialize",
          value: function() {
      ...
      var t2 = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.$editor = t.layoutInfo.editor, this.$toolbar = t.layoutInfo.toolbar, this.$editable = t.layoutInfo.editable, this.$codable = t.layoutInfo.codable, this.$window = i()(window), this.$scrollbar = i()("html, body"), this.onResize = function() {
            e.resizeTo({
      ...
      var tU = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.$document = i()(document), this.$editingArea = t.layoutInfo.editingArea, this.options = t.options, this.lang = this.options.langInfo, this.events = {
            "summernote.mousedown": function(t, n) {
              e.update(n.target, n) && n.preventDefault()
            },
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            this.$handle = i()(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>", ].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", function(e) {
              if (th.isControlSizing(e.target)) {
                e.preventDefault(), e.stopPropagation();
                ...
                t.$document.on("mousemove", a).one("mouseup", function(e) {
                  e.preventDefault(), t.$document.off("mousemove", a), t.context.invoke("editor.afterCommand")
          ...
          value: function(t, e) {
            ...
            if (this.context.invoke("imagePopover.update", t, e), n) {
              var a = i()(t),
                r = a.position(),
                s = {
                  left: r.left + parseInt(a.css("marginLeft"), 10),
                  top: r.top + parseInt(a.css("marginTop"), 10)
                },
                l = {
                  w: a.outerWidth(!1),
                  h: a.outerHeight(!1)
      ...
      var t3 = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|tel:|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i,
        t5 = function() {
          var t, e, n;
          ...
          function o(t) {
            ...
            ! function(t, e) {
              if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
            }(this, o), this.context = t, this.options = t.options, this.events = {
          ...
          return t = o, e = [{
              ...
              if (this.lastWordRange) {
                ...
                if (e && (e[1] || e[2])) {
                  var n = e[1] ? t : "http://" + t,
                    ...
                    a = i()("<a />").html(o).attr("href", n)[0];
                  this.context.options.linkTargetBlank && i()(a).attr("target", "_blank"), this.lastWordRange.insertNode(a), this.lastWordRange = null, this.context.invoke("editor.focus")
                }
              }
            }
          }, {
            key: "handleKeydown",
            value: function(t) {
              if (C.contains([tC.code.ENTER, tC.code.SPACE], t.keyCode)) {
            ...
            key: "handleKeyup",
            value: function(t) {
              C.contains([tC.code.ENTER, tC.code.SPACE], t.keyCode) && this.replace()
            }
          }, ], t7(t.prototype, e), n && t7(t, n), o
        }();
      ...
      var tW = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.$note = t.layoutInfo.note, this.events = {
        ...
        return t = o, e = [{
          ...
          value: function() {
            return th.isTextarea(this.$note[0])
          }
        }, ], t6(t.prototype, e), n && t6(t, n), o
      }();
      ...
      var tK = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.options = t.options.replace || {}, this.keys = [tC.code.ENTER, tC.code.SPACE, tC.code.PERIOD, tC.code.COMMA, tC.code.SEMICOLON, tC.code.SLASH], this.previousKeydownCode = null, this.events = {
            "summernote.keyup": function(t, n) {
              n.isDefaultPrevented() || e.handleKeyup(n)
            },
            "summernote.keydown": function(t, n) {
          ...
          value: function() {
            if (this.lastWord) {
              ...
              this.options.match(e, function(e) {
                if (e) {
                  var n = "";
                  "string" == typeof e ? n = th.createText(e) : e instanceof jQuery ? n = e[0] : e instanceof Node && (n = e), n && (t.lastWord.insertNode(n), t.lastWord = null, t.context.invoke("editor.focus"))
                }
              })
            }
          }
      ...
      var tq = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.$editingArea = t.layoutInfo.editingArea, this.options = t.options, !0 === this.options.inheritPlaceholder && (this.options.placeholder = this.context.$note.attr("placeholder") || this.options.placeholder), this.events = {
      ...
      var tG = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.ui = i.a.summernote.ui, this.context = t, this.$toolbar = t.layoutInfo.toolbar, this.options = t.options, this.lang = this.options.langInfo, this.invertedKeyMap = m.invertObject(this.options.keyMap[p.isMac ? "mac" : "pc"])
        }
        return t = o, e = [{
          ...
          key: "isFontInstalled",
          value: function(t) {
            return Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) || (this.fontInstalledMap[t] = p.isFontInstalled(t) || C.contains(this.options.fontNamesIgnoreCheck, t)), this.fontInstalledMap[t]
          }
        }, {
          key: "isFontDeservedToAdd",
          value: function(t) {
            return "" !== (t = t.toLowerCase()) && this.isFontInstalled(t) && -1 === p.genericFontFamilies.indexOf(t)
          }
        }, {
          key: "colorPalette",
            ...
            return this.ui.buttonGroup({
              ...
              children: [this.button({
                ...
                click: function(t) {
                  ...
                  n && o ? a.context.invoke("editor.color", {
                    backColor: e.attr("data-backColor"),
                    foreColor: e.attr("data-foreColor")
                  }) : n ? a.context.invoke("editor.color", {
                    backColor: e.attr("data-backColor")
                  }) : o && a.context.invoke("editor.color", {
                    foreColor: e.attr("data-foreColor")
                  })
                },
                callback: function(t) {
                  var e = t.find(".note-recent-color");
                  n && (e.css("background-color", a.options.colorButton.backColor), t.attr("data-backColor", a.options.colorButton.backColor)), o ? (e.css("color", a.options.colorButton.foreColor), t.attr("data-foreColor", a.options.colorButton.foreColor)) : e.css("color", "transparent")
                }
              }), this.button({
                ...
                callback: function(t) {
                  t.find(".note-holder").each(function(t, e) {
                    var n = i()(e);
                    n.append(a.ui.palette({
                      colors: a.options.colors,
                      colorsName: a.options.colorsName,
                      eventName: n.data("event"),
                      container: a.options.container,
                      tooltip: a.options.tooltip
                    }).render())
                  });
                  var e = [
                ...
                click: function(e) {
                  ...
                  if ("openPalette" === r) {
                    ...
                    if (C.contains(["backColor", "foreColor"], r)) {
                      var h = o.closest(".note-color").find(".note-recent-color"),
                        f = o.closest(".note-color").find(".note-current-color-button");
                      h.css("backColor" === r ? "background-color" : "color", s), f.attr("data-" + r, s)
                    }
                    a.context.invoke("editor." + r, s)
                  }
                }
              }), ]
            }).render()
          ...
          value: function() {
            ...
            for (var e = 0, n = this.options.styleTags.length; e < n; e++)(function(e, n) {
            ...
            this.context.memo("button.bold", function() {
              ...
              return t.options.addDefaultFonts && i.a.each(e["font-family"].split(","), function(e, n) {
                ...
                template: function(t) {
                  return '<span style="font-family: ' + p.validFontName(t) + '">' + t + "</span>"
                },
            ...
            this.context.memo("button.justifyLeft", m.invoke(o, "render")), this.context.memo("button.justifyCenter", m.invoke(a, "render")), this.context.memo("button.justifyRight", m.invoke(r, "render")), this.context.memo("button.justifyFull", m.invoke(s, "render")), this.context.memo("button.outdent", m.invoke(l, "render")), this.context.memo("button.indent", m.invoke(c, "render")), this.context.memo("button.paragraph", function() {
              return t.ui.buttonGroup([t.button({
                className: "dropdown-toggle",
          ...
          value: function(t, e) {
            for (var n = 0, o = e.length; n < o; n++) {
              for (var i = e[n], a = Array.isArray(i) ? i[0] : i, r = Array.isArray(i) ? 1 === i.length ? [i[0]] : i[1] : [i], s = this.ui.buttonGroup({
                  className: "note-" + a
                }).render(), l = 0, c = r.length; l < c; l++) {
                var u = this.context.memo("button." + r[l]);
          ...
          value: function(t) {
            ...
            if (this.updateBtnStates(n, {
              ...
              var a = o["font-family"].split(",").map(function(t) {
                  return t.replace(/[\'\"]/g, "").replace(/\s+$/, "").replace(/^\s+/, "")
                }),
                r = C.find(a, this.isFontInstalled.bind(this));
          ...
          value: function(t) {
            var e, n = i()(t.target.parentNode),
              o = n.next(),
              a = n.find(".note-dimension-picker-mousecatcher"),
            ...
            r.css({
              width: c + "em",
              height: u + "em"
            }), a.data("value", c + "x" + u), c > 3 && c < this.options.insertTableMaxSize.col && s.css({
              width: c + 1 + "em"
            }), u > 3 && u < this.options.insertTableMaxSize.row && s.css({
              height: u + 1 + "em"
            }), o.html(c + " x " + u)
          }
        }, ], t8(t.prototype, e), n && t8(t, n), o
      }();
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            var t = this.$editor.outerHeight(),
              ...
              a = 0;
            this.options.otherStaticBar && (a = i()(this.options.otherStaticBar).outerHeight());
            var r = this.$document.scrollTop(),
              s = this.$editor.offset().top,
              l = s - a,
              c = s + t - a - n - o;
            !this.isFollowing && r > l && r < c - n ? (this.isFollowing = !0, this.$editable.css({
      ...
      var tQ = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.$body = i()(document.body), this.$editor = t.layoutInfo.editor, this.options = t.options, this.lang = this.options.langInfo, t.memo("help.linkDialog.show", this.options.langInfo.help["linkDialog.show"])
        }
        return t = o, e = [{
          key: "initialize",
          value: function() {
          ...
          value: function(t, e) {
            t.on("keypress", function(t) {
              t.keyCode === tC.code.ENTER && (t.preventDefault(), e.trigger("click"))
            })
          }
        }, {
          key: "toggleLinkBtn",
          ...
          value: function(t) {
            ...
            return i.a.Deferred(function(n) {
              var o = e.$dialog.find(".note-link-text"),
                ...
                a = e.$dialog.find(".note-link-btn"),
                r = e.$dialog.find(".sn-checkbox-open-in-new-window input[type=checkbox]"),
                s = e.$dialog.find(".sn-checkbox-use-protocol input[type=checkbox]");
              e.ui.onDialogShown(e.$dialog, function() {
                e.context.triggerEvent("dialog.shown"), !t.url && m.isValidUrl(t.text) && (t.url = t.text), o.on("input paste propertychange", function() {
                  t.text = o.val(), e.toggleLinkBtn(a, o, i)
                }).val(t.text), i.on("input paste propertychange", function() {
                  t.text || o.val(i.val()), e.toggleLinkBtn(a, o, i)
                }).val(t.url), p.isSupportTouch || i.trigger("focus"), e.toggleLinkBtn(a, o, i), e.bindEnterKey(i, a), e.bindEnterKey(o, a);
                var l = void 0 !== t.isNewWindow ? t.isNewWindow : e.context.options.linkTargetBlank;
                r.prop("checked", l);
                var c = !t.url && e.context.options.useProtocol;
                s.prop("checked", c), a.one("click", function(a) {
                  a.preventDefault(), n.resolve({
                    range: t.range,
                    url: i.val(),
                    text: o.val(),
                ...
                o.off(), i.off(), a.off(), "pending" === n.state() && n.reject()
      ...
      var et = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.options = t.options, this.events = {
          ...
          value: function() {
            if (this.context.invoke("editor.hasFocus")) {
              ...
              if (t.isCollapsed() && t.isOnAnchor()) {
                ...
                var o = th.posFromPlaceholder(e),
                  a = i()(this.options.container).offset();
                o.top -= a.top, o.left -= a.left, this.$popover.css({
                  display: "block",
                  left: o.left,
                  top: o.top
                })
      ...
      var en = function() {
        ...
        function o(t) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.$body = i()(document.body), this.$editor = t.layoutInfo.editor, this.options = t.options, this.lang = this.options.langInfo
        }
        return t = o, e = [{
          key: "initialize",
          value: function() {
            ...
            var o = this.options.dialogsInBody ? this.$body : this.options.container,
              ...
              a = '<input type="button" href="#" class="'.concat("btn btn-primary note-btn note-btn-primary note-image-btn", '" value="').concat(this.lang.image.insert, '" disabled>');
            this.$dialog = this.ui.dialog({
          ...
          value: function() {
            ...
            return i.a.Deferred(function(e) {
              ...
              t.ui.onDialogShown(t.$dialog, function() {
                ...
                }).val(""), p.isSupportTouch || o.trigger("focus"), i.click(function(t) {
      ...
      var ei = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.editable = t.layoutInfo.editable[0], this.options = t.options, this.events = {
            "summernote.disable summernote.blur": function() {
              e.hide()
            }
          }
          ...
          value: function(t, e) {
            if (th.isImg(t)) {
              var n = i()(t).offset(),
                ...
                a = {};
              this.options.popatmouse ? (a.left = e.pageX - 20, a.top = e.pageY) : a = n, a.top -= o.top, a.left -= o.left, this.$popover.css({
                display: "block",
                left: a.left,
                top: a.top
              })
      ...
      var er = function() {
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            var t = this.$popover.find(".popover-content,.note-popover-content");
            this.context.invoke("buttons.build", t, this.options.popover.table), p.isFF && document.execCommand("enableInlineTableEditing", !1, !1), this.$popover.on("mousedown", function(t) {
              t.preventDefault()
            })
          }
        }, {
          ...
          value: function(t) {
            ...
            if (n && 11 === n[1].length) {
              ...
              if (void 0 !== n[2]) {
                ...
                if (g)
                  for (var b = [3600, 60, 1], k = 0, y = b.length; k < y; k++) m += void 0 !== g[k + 1] ? b[k] * parseInt(g[k + 1], 10) : 0
              }
              e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://www.youtube.com/embed/" + v + (m > 0 ? "?start=" + m : "")).attr("width", "640").attr("height", "360")
            ...
            else if (a && a[0].length) e = i()("<iframe>").attr("frameborder", 0).attr("src", a[0] + "/embed/simple").attr("width", "600").attr("height", "600").attr("class", "vine-embed");
            else if (r && r[3].length) e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "https://player.vimeo.com/video/" + r[3]).attr("width", "640").attr("height", "360");
              ...
              var C = c && c[1].length ? c[1] : u[2];
              e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "https://v.qq.com/txp/iframe/player.html?vid=" + C + "&amp;auto=0")
          ...
          value: function() {
            ...
            return i.a.Deferred(function(e) {
              ...
              t.ui.onDialogShown(t.$dialog, function() {
                ...
                }), p.isSupportTouch || n.trigger("focus"), o.click(function(t) {
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            this.$dialog = this.ui.dialog({
              ...
              footer: '<p class="text-center"><a href="http://summernote.org/" target="_blank">Summernote 0.8.18</a> \xb7 <a href="https://github.com/summernote/summernote" target="_blank">Project</a> \xb7 <a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a></p>',
              callback: function(t) {
          ...
          value: function() {
            var t = this,
              e = this.options.keyMap[p.isMac ? "mac" : "pc"];
            return Object.keys(e).map(function(n) {
              var o = e[n],
                a = i()('<div><div class="help-list-item"></div></div>');
              return a.append(i()("<label><kbd>" + n + "</kdb></label>").css({
                width: 180,
                "margin-right": 10
              })).append(i()("<span/>").html(t.context.memo("help." + o) || o)), a.html()
            }).join("")
          }
        }, {
          key: "showHelpDialog",
      ...
      var eh = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.options = t.options, this.hidable = !0, this.onContextmenu = !1, this.pageX = null, this.pageY = null, this.events = {
            "summernote.contextmenu": function(t) {
              e.options.editing && (t.preventDefault(), t.stopPropagation(), e.onContextmenu = !0, e.update(!0))
            },
            "summernote.mousedown": function(t, n) {
              e.pageX = n.pageX, e.pageY = n.pageY
            },
            "summernote.keyup summernote.mouseup summernote.scroll": function(t, n) {
              e.options.editing && !e.onContextmenu && (e.pageX = n.pageX, e.pageY = n.pageY, e.update()), e.onContextmenu = !1
            },
            "summernote.disable summernote.change summernote.dialog.shown summernote.blur": function() {
              e.hide()
            },
            "summernote.focusout": function() {
              e.$popover.is(":active,:focus") || e.hide()
            }
          }
        }
        return t = o, e = [{
      ...
      var ep = function() {
        ...
        function o(t) {
          ...
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.context = t, this.ui = i.a.summernote.ui, this.$editable = t.layoutInfo.editable, this.options = t.options, this.hint = this.options.hint || [], this.direction = this.options.hintDirection || "bottom", this.hints = Array.isArray(this.hint) ? this.hint : [this.hint], this.events = {
            "summernote.keyup": function(t, n) {
              n.isDefaultPrevented() || e.handleKeyup(n)
            },
            "summernote.keydown": function(t, n) {
        ...
        return t = o, e = [{
          ...
          value: function() {
            ...
            if (t.length) {
              ...
              if (this.lastWordRange.insertNode(e), "next" === this.options.hintSelect) {
                ...
                i()(e).after(o), tk.createFromNodeBefore(o).select()
              } else tk.createFromNodeAfter(e).select();
          ...
          value: function(t) {
            ...
            return "string" == typeof o && (o = th.createText(o)), o
          }
        }, {
          ...
          key: "handleKeydown",
          value: function(t) {
            this.$popover.is(":visible") && (t.keyCode === tC.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === tC.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === tC.code.DOWN && (t.preventDefault(), this.moveDown()))
          }
        }, {
          key: "searchKeyword",
          value: function(t, e, n) {
          ...
          value: function(t) {
            var e = this;
            if (!C.contains([tC.code.ENTER, tC.code.UP, tC.code.DOWN], t.keyCode)) {
              var n, o, a = this.context.invoke("editor.getLastRange");
              if ("words" === this.options.hintMode) {
                if (o = (n = a.getWordsRange(a)).toString(), this.hints.forEach(function(t) {
                    if (t.match.test(o)) return n = a.getWordsMatchRange(t.match), !1
                  }), !n) return void this.hide();
                o = n.toString()
              } else o = (n = a.getWordRange()).toString();
              if (this.hints.length && o) {
                this.$content.empty();
                var r = m.rect2bnd(C.last(n.getClientRects())),
                  s = i()(this.options.container).offset();
                r && (r.top -= s.top, r.left -= s.left, this.$popover.hide(), this.lastWordRange = n, this.hints.forEach(function(t, n) {
    ...
    51: function(t, e, n) {
      ...
      var s = function() {
        ...
        function o(t, e) {
          if (function(t, e) {
              if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
            }(this, o), this.$node = t, this.options = i.a.extend({}, {
              title: "",
              target: e.container,
              trigger: "hover focus",
              placement: "bottom"
            }, e), this.$tooltip = i()('<div class="note-tooltip"><div class="note-tooltip-arrow"></div><div class="note-tooltip-content"></div></div>'), "manual" !== this.options.trigger) {
            var n = this.show.bind(this),
              a = this.hide.bind(this),
              r = this.toggle.bind(this);
            this.options.trigger.split(" ").forEach(function(e) {
              "hover" === e ? (t.off("mouseenter mouseleave"), t.on("mouseenter", n).on("mouseleave", a)) : "click" === e ? t.on("click", r) : "focus" === e && t.on("focus", n).on("blur", a)
            })
          }
        }
        return t = o, e = [{
          ...
          value: function() {
            ...
            var o = this.$tooltip,
              a = this.options.title || t.attr("title") || t.data("title"),
              r = this.options.placement || t.data("placement");
            o.addClass(r), o.find(".note-tooltip-content").text(a), o.appendTo(this.options.target);
            var s = t.outerWidth(),
              l = t.outerHeight(),
              c = o.outerWidth(),
              u = o.outerHeight();
      ...
      var c = function() {
        ...
        function o(t, e) {
          ! function(t, e) {
            if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
          }(this, o), this.$button = t, this.options = i.a.extend({}, {
            target: e.container
          }, e), this.setEvent()
        }
        return t = o, e = [{
          ...
          value: function() {
            ...
            var t = this.$button.next(),
              ...
              n = t.outerWidth(),
              o = i()(window).width(),
              a = parseFloat(i()(this.options.target).css("margin-right"));
            e.left + n > o - a ? t.css("margin-left", o - a - (e.left + n)) : t.css("margin-left", "")
          }
        }, {
          key: "hide",
          value: function() {
      ...
      var h = function() {
          ...
          function o(t) {
            ! function(t, e) {
              if (!(t instanceof e)) throw TypeError("Cannot call a class as a function")
            }(this, o), this.$modal = t, this.$backdrop = i()('<div class="note-modal-backdrop"/>')
          }
          return t = o, e = [{
            key: "show",
            value: function() {
        ...
        f = a.a.create('<div class="note-editor note-frame"/>'),
        p = a.a.create('<div class="note-toolbar" role="toolbar"/>'),
        v = a.a.create('<div class="note-editing-area"/>'),
        m = a.a.create('<textarea class="note-codable" aria-multiline="true"/>'),
        g = a.a.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>'),
        b = a.a.create('<output class="note-status-output" role="status" aria-live="polite"></output><div class="note-statusbar" role="status"><div class="note-resizebar" aria-label="resize"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div></div>'),
        k = a.a.create('<div class="note-editor note-airframe"/>'),
        y = a.a.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div><output class="note-status-output" role="status" aria-live="polite"></output>'),
        C = a.a.create('<div class="note-btn-group">'),
        w = a.a.create('<button type="button" class="note-btn" tabindex="-1">', function(t, e) {
          e && e.tooltip && (t.attr({
        ...
        x = a.a.create('<div class="note-dropdown-menu" role="list">', function(t, e) {
          var n = Array.isArray(e.items) ? e.items.map(function(t) {
            var n = "string" == typeof t ? t : t.value || "",
              o = e.template ? e.template(t) : t,
              a = i()('<a class="note-dropdown-item" href="#" data-value="' + n + '" role="listitem" aria-label="' + n + '"></a>');
            return a.html(o).data("item", t), a
          }) : e.items;
          t.html(n).attr({
            "aria-label": e.title
            ...
            var n = i()(this),
              o = n.data("item"),
              a = n.data("value");
            o.click ? o.click(n) : e.itemClick && e.itemClick(t, o, a)
          }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep")
        }),
        $ = a.a.create('<div class="note-dropdown-menu note-check" role="list">', function(t, e) {
          var n = Array.isArray(e.items) ? e.items.map(function(t) {
            var n = "string" == typeof t ? t : t.value || "",
              o = e.template ? e.template(t) : t,
              a = i()('<a class="note-dropdown-item" href="#" data-value="' + n + '" role="listitem" aria-label="' + t + '"></a>');
            return a.html([B(e.checkClassName), " ", o]).data("item", t), a
          }) : e.items;
          t.html(n).attr({
            "aria-label": e.title
          }), t.on("click", "> .note-dropdown-item", function(t) {
        ...
        _ = function(t, e) {
          return C([w({
            className: "dropdown-toggle",
            contents: t.title + " " + B("note-icon-caret"),
            tooltip: t.tooltip,
            data: {
              toggle: "dropdown"
            }
          ...
          return C([w({
            ...
            callback: function(e) {
              e.find(".note-dimension-picker-mousecatcher").css({
                ...
                ! function(t, e, n) {
                  var o, a = i()(t.target.parentNode),
                    r = a.next(),
                    s = a.find(".note-dimension-picker-mousecatcher"),
                    l = a.find(".note-dimension-picker-highlighted"),
                    c = a.find(".note-dimension-picker-unhighlighted");
                  if (void 0 === t.offsetX) {
        ...
        E = a.a.create('<div class="note-color-palette"/>', function(t, e) {
          for (var n = [], o = 0, a = e.colors.length; o < a; o++) {
            for (var r = e.eventName, l = e.colors[o], c = e.colorsName[o], u = [], d = 0, h = l.length; d < h; d++) {
              var f = l[d],
                p = c[d];
              u.push(['<button type="button" class="note-btn note-color-btn"', 'style="background-color:', f, '" ', 'data-event="', r, '" ', 'data-value="', f, '" ', 'data-title="', p, '" ', 'aria-label="', p, '" ', 'data-toggle="button" tabindex="-1"></button>', ].join(""))
            }
          ...
          return C({
            ...
            children: [w({
              ...
              click: function(n) {
                ...
                if ("cp" === r ? n.stopPropagation() : "cpbackColor" === r ? r = l : "cpforeColor" === r && (r = s), a && r) {
                  var c = o.closest(".note-color").find(".note-recent-color"),
                    u = o.closest(".note-color").find(".note-current-color-button");
                  c.css("backColor" === a ? "background-color" : "color", r), u.attr("data-" + a, r), "fore" === e ? t.itemClick("foreColor", r) : "back" === e ? t.itemClick("backColor", r) : t.itemClick(a, r)
                }
              }
            }), ]
          }).render()
        },
        R = a.a.create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function(t, e) {
        ...
        D = a.a.create('<div class="note-popover bottom"><div class="note-popover-arrow"></div><div class="popover-content note-children-container"></div></div>', function(t, e) {
          var n = void 0 !== e.direction ? e.direction : "bottom";
          t.addClass(n).hide(), e.hideArrow && t.find(".note-popover-arrow").hide()
        }),
        H = a.a.create('<div class="checkbox"></div>', function(t, e) {
        ...
        z = function(t) {
          return {
            ...
            paragraphDropdownButton: T,
            tableDropdownButton: I,
            colorDropdownButton: P,
            palette: E,
            dialog: R,
            videoDialog: L,
            imageDialog: A,
            ...
            createLayout: function(e) {
              var n = (t.airMode ? k([v([m(), y()])]) : "bottom" === t.toolbarPosition ? f([v([m(), g()]), p(), b()]) : f([p(), v([m(), g()]), b()])).render();
      ...
      n(3), n(6), i.a.summernote = i.a.extend(i.a.summernote, {
        ui_template: z,
        interface: "lite"
      })
    },
...
//# sourceMappingURL=summernote-lite-unminified.min.js.map