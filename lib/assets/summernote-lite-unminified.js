              ...
              value: function () {
                ...
                (this.documentEventHandlers.onDragenter = function (o) {
                  ...
                  if (matchedFileTypes && matchedFileTypes.length) {
                    ...
                    var r = t.$editor.width() > 0 && t.$editor.height() > 0;
                    if (!i && !e.length && r) {
                      t.$editor.addClass('dragover');
                      if (!t.$dropzone.width()) {
                        t.$dropzone.width(t.$editor.width());
                      }
                      if (!t.$dropzone.height()) {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.context.memo("button.linkDialogShow", function () {
                  return t.button({ contents: t.ui.icon(t.options.icons.link), tooltip: t.lang.link.edit }).render();
                }),
